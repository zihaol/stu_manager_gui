...
QT_MOC_LITERAL(1, 13, 6), // "MyShow"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 4), // "nNum"
QT_MOC_LITERAL(4, 26, 9), // "OnTouchOk"
QT_MOC_LITERAL(5, 36, 13) // "OnTouchCancel"

    },
    "DialogAddStu\0MyShow\0\0nNum\0OnTouchOk\0"
    "OnTouchCancel"
};
...
void DialogAddStu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->MyShow((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->OnTouchOk(); break;
        case 2: _t->OnTouchCancel(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DialogAddStu::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DialogAddStu::MyShow)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DialogAddStu::MyShow(int _t1)
{
